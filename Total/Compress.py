'''
调整一个目录下的n个文件夹中的所有图片的大小,长宽不超过阈值，按照比例放缩
Author ： Fu Jingyun
'''
import os
import random
...
#给定操作目录
path='C:/Users/NExT/Desktop/Sort_NBF_cleaned'
newpath = 'C:/Users/NExT/Desktop/NBF_compressed'
...
#        print "图片名称为"+pic+"图片被修改"
                 try: 
                     ...
                     if temppath[-4]=='.':
                         ...
                         new_path=newsubpath+'/'+str(namenum)+temppath[-5:]
                     out.save(new_path)
                     namenum+=1
                 except:
                     print(temppath)
