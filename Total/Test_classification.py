...
for food_label, img_list in val_dict_img_list.items():
    ...
    food_results[food_label] = {"top1":0,"top5":0,"top25":0,"foundIn":[],"recogResult":{},"img_tested":[],"total":len(img_list),"foodaccuracy_top1":0,\
                "foodaccuracy_top5":0,"foodaccuracy_top25":0}
    ...
    total_top1+=food_results[food_label]["foodaccuracy_top1"]
    total_top5+=food_results[food_label]["foodaccuracy_top5"]
    total_top25+=food_results[food_label]["foodaccuracy_top25"]
print("Done!")
