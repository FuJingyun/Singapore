...
model_name = "resnet50"
model_path = "/media/Share/jingyun/Pytorch-training/files/snapshot/BestWeight-foodNonfood-res50-16-08-2019_17-00-44.pth"
...
val_dict_img_list = dataset_list_JJ("/media/Share/jingyun/data/test_LBY")
...
resStartRow += 1
errAnaWorkbook.save("test0910.xlsx")
