...
#给定操作目录
path='C:/Users/NExT/Desktop/New_BF&S_train'
newpath = 'C:/Users/NExT/Desktop/New_BF&S_train_ok'
problempath= 'C:/Users/NExT/Desktop/Problem_train_0906'
...
#                   shutil.copy(temppath, dst)
                 ...
                 i=i.convert("RGB")
#                 if temppath[-4]=='.':   
                 dst=problempath+'/'+'a'+str(namenum)+'.jpg'
                 namenum+=1
#                   shutil.copy(temppath, dst)
                 i.save(dst)
#                 elif temppath[-5]=='.':
